...
function createApkBox() {
    ...
    <div class="slotmania89-box">
      <div class="left-panel">
        ...
        <button class="main-link" type="button" id="copyMainLinkBtn">
          altwin.link/slotmania89
        </button>

        <div class="label">Pilih Link Alternatif:</div>

        <select id="altLink">
          <option value="https://link1.akses-terpercaya.com">link resmi 1</option>
          <option value="https://link2.akses-terpercaya.com">link resmi 2</option>
          <option value="https://link3.akses-terpercaya.com">link resmi 3</option>
        </select>
  ...
  if (copyMainLinkBtn) {
    copyMainLinkBtn.addEventListener("click", function () {
      const value = "https://altwin.link/slotmania89link";
